 ...
 *******************************************************************************
 * STM32 port note:
 *   The platform header (mqtt_port.h) provides the Timer and Network types
 *   required by MQTTClient.h. The network is implemented on top of ESP-01S
 *   AT transparent mode (USART2), so no LWIP / FreeRTOS+TCP is needed.
 ******************************************************************************/
